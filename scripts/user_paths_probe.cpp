...
// {"file":"scripts/user_paths_probe.cpp","purpose":"CLI probe to exercise user path helpers under different modes.","depends_on":["user_paths.h","<filesystem>","<iostream>","<fstream>"],"notes":["outputs_JSON_for_automation","invokes_core_library_without_UI"]}
// Human Summary
