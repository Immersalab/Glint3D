...
REM {"file":"tools/qem_simplifier/build-and-run.bat","purpose":"Builds and runs the standalone QEM scaffold targets with fast local iteration modes.","exports":[],"depends_on":["cmake","tools/qem_simplifier/CMakeLists.txt"],"notes":["modes_configure_build_run_smoke_clean","standalone_qem_loop"]}
REM Human Summary
...
cmake -S tools/qem_simplifier -B "%BUILD_DIR%"
