...
// {"file":"tools/qem_simplifier/include/glint_qem_tool/qem_core_simplifier_backend.h","purpose":"Declares the in-process simplifier backend that wraps the stub qem_core API.","exports":["QemCoreSimplifierBackend"],"depends_on":["glint_qem_tool/backends.h"],"notes":["pass_through_stub_initially"]}
// Human Summary
