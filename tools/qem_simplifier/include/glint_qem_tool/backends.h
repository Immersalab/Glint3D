...
// {"file":"tools/qem_simplifier/include/glint_qem_tool/backends.h","purpose":"Declares in-process backend interfaces for simplification and Glint rendering preview orchestration.","exports":["ISimplifyBackend","IRenderBackend","SimplifyJob","RenderPreviewJob"],"depends_on":["glint_qem/simplify.h","glint_qem_tool/backend_contracts.h","<string>","<vector>"],"notes":["interface_first","plugin_abi_conscious","external_ui_shell_consumer"]}
// Human Summary
