...
// {"file":"tools/qem_simplifier/include/glint_qem_tool/obj_mesh_io.h","purpose":"Declares OBJ mesh IO helpers for the external QEM tool layer (not qem_core).","exports":["ReadObjMesh"],"depends_on":["glint_qem/types.h","<string>"],"notes":["tinyobjloader_adapter_boundary","qem_core_remains_in_memory_only"]}
// Human Summary
