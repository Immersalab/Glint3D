...
{"file":"apps/qem_simplifier/docs/BACKEND_INTERFACE_DISCUSSION.md","purpose":"Explains the staged path from internal backend interfaces to a future true plugin ABI for QEM and rendering backends.","exports":["backend_vs_plugin_guidance","abi_conscious_rules","migration_plan"],"depends_on":["apps/qem_simplifier/include/glint_qem_tool/backend_contracts.h","apps/qem_simplifier/include/glint_qem_tool/backends.h"],"notes":["plugin_ready_shapes","capability_discovery","versioning_first"]}
<!-- Human Summary -->
