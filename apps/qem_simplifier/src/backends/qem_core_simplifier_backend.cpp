...
// {"file":"apps/qem_simplifier/src/backends/qem_core_simplifier_backend.cpp","purpose":"Implements the in-process simplifier backend by forwarding jobs to the qem_core stub API.","exports":["glint_qem_tool::QemCoreSimplifierBackend"],"depends_on":["glint_qem_tool/qem_core_simplifier_backend.h"],"notes":["backend_interface_smoke_path"]}
// Human Summary
