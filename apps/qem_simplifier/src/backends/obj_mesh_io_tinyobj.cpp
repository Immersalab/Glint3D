...
// {"file":"apps/qem_simplifier/src/backends/obj_mesh_io_tinyobj.cpp","purpose":"Implements OBJ import for the QEM external tool via tinyobjloader when available.","exports":["glint_qem_tool::ReadObjMesh"],"depends_on":["glint_qem_tool/obj_mesh_io.h"],"notes":["tool_layer_io","graceful_no_header_error","positions_plus_triangle_indices_only"]}
// Human Summary
