...
// {"file":"apps/qem_simplifier/include/glint_qem/types.h","purpose":"Defines core QEM mesh/value types and status codes independent of Glint and UI/render backends.","exports":["Vec3f","IndexedTriangleMesh","SimplifyStatus"],"depends_on":["<cstdint>","<vector>"],"notes":["stl_only","plugin_boundary_avoids_glm"]}
// Human Summary
