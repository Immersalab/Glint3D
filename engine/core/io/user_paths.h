...
// {"file":"engine/core/io/user_paths.h","purpose":"Public API for Glint3D user data, config, and cache directories.","exports":["glint::getUserDataDir","glint::getConfigDir","glint::getCacheDir","glint::isPortableMode","glint::enablePortableMode","glint::getDataPath","glint::getConfigPath","glint::getCachePath"],"depends_on":["<filesystem>","<string>"],"notes":["portable_mode_respects_runtime_overrides"]}
// Human Summary
// Declares cross-platform helpers for locating persistent directories and toggling portable mode.
#pragma once
