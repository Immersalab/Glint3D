...
// {"file":"engine/core/application/application_core.cpp","purpose":"Coordinates the application lifecycle, window bootstrap, and render loop orchestration.","depends_on":["application_core.h","render_system.h","scene_manager.h","ui_bridge.h"],"notes":["platform_bootstrap_requires_glfw"]}
// Human Summary
// Implements initialization, main loop control, and platform glue for the Glint3D desktop application.
